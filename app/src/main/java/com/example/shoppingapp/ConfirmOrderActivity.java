...
public class ConfirmOrderActivity extends AppCompatActivity
{
    ...
    private void ConfirmOrder()
    {
        ...
        //new_new_edit
        final DatabaseReference viewRef = FirebaseDatabase.getInstance("https://onlineshoppingapp-c0171-default-rtdb.asia-southeast1.firebasedatabase.app").getReference().child("ViewOrders").child(Prevalent.currentUser.getPhone());
        ...
        viewRef.updateChildren(viewMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task)
            {
                if (task.isSuccessful())
                {
                    ...
                    FirebaseDatabase.getInstance("https://onlineshoppingapp-c0171-default-rtdb.asia-southeast1.firebasedatabase.app").getReference()
                            .child("Cart List")
                            .child("User View")
        ...
        final DatabaseReference ordersRef = FirebaseDatabase.getInstance("https://onlineshoppingapp-c0171-default-rtdb.asia-southeast1.firebasedatabase.app").getReference().child("Orders").child(Prevalent.currentUser.getPhone());
