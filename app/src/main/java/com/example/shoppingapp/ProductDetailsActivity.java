...
public class ProductDetailsActivity extends AppCompatActivity
{
    ...
    private void addToWishList()
    {
        ...
        final DatabaseReference wishListRef = FirebaseDatabase.getInstance("https://onlineshoppingapp-c0171-default-rtdb.asia-southeast1.firebasedatabase.app").getReference().child("Wish List");
    ...
    private void addToCartList()
    {
        ...
        final DatabaseReference cartListRef = FirebaseDatabase.getInstance("https://onlineshoppingapp-c0171-default-rtdb.asia-southeast1.firebasedatabase.app").getReference().child("Cart List");
    ...
    {
        DatabaseReference productRef = FirebaseDatabase.getInstance("https://onlineshoppingapp-c0171-default-rtdb.asia-southeast1.firebasedatabase.app").getReference().child("Products");
    ...
    private void CheckOrderState()
    {
        ...
        ordersRef = FirebaseDatabase.getInstance("https://onlineshoppingapp-c0171-default-rtdb.asia-southeast1.firebasedatabase.app").getReference().child("Orders").child(Prevalent.currentUser.getPhone());
