...
public class SearchProductsActivity extends AppCompatActivity
{
    ...
    protected void onStart()
    {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance("https://onlineshoppingapp-c0171-default-rtdb.asia-southeast1.firebasedatabase.app").getReference().child("Products");
