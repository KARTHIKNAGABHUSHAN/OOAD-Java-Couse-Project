...
public class ViewOrdersActivity extends AppCompatActivity
{
    ...
    protected void onStart() {
        ...
        final DatabaseReference orderListRef = FirebaseDatabase.getInstance("https://onlineshoppingapp-c0171-default-rtdb.asia-southeast1.firebasedatabase.app").getReference().child("ViewOrders");
