...
public class SettingsActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageProfileImgReference = FirebaseStorage.getInstance("https://onlineshoppingapp-c0171-default-rtdb.asia-southeast1.firebasedatabase.app").getReference().child("Profile pictures");
    ...
    private void UpdateUserInfo()
    {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance("https://onlineshoppingapp-c0171-default-rtdb.asia-southeast1.firebasedatabase.app").getReference().child("Users");
    ...
    {
        DatabaseReference UsersRef = FirebaseDatabase.getInstance("https://onlineshoppingapp-c0171-default-rtdb.asia-southeast1.firebasedatabase.app").getReference().child("Users").child(Prevalent.currentUser.getPhone());
